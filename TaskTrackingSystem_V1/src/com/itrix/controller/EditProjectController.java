...
public class EditProjectController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String projID=request.getParameter("hiddenIDForUpdt");
		...
		for(int i=0;i< catgValue.length;i++)
		{
		 ...
		 boolean result = proMastSerObj.updtProjMastSer(proBeanObj);	
		 ...
		 String Msg =rb.getString("PorojectMastAddSuccessMsg");
			...
			response.sendRedirect("JSP/ProjectEditMast.jsp");
		 }else
			{
